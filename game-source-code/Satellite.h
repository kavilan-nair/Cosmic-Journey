...
/**
* Satellite class - represents the Enemy ship.
...
class Satellite : public IShootingMovingEntity
{
	public:
		...
		*/
		...
		/**
		* @brief Default deconstructor. Destroys the Satellite once it has gone out of scope.
		*/
		~Satellite();
		/**
		...
		*/
		...
		/**
		* @brief Inherited from IShootingMovingEntity. Returns a whether Satellite is alive or not.
		...
		* @return Float with radius of the Satellite.
		*/
